...
@section('content')
    <div class="container-fluid px-4">
        ...
        @endif
        <div>
            <form action="{{ route('outlets.update', $outlet->outlets_id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="nm_outlet" type="text" class="form-control @error('nm_outlet') is-invalid @enderror"
                            name="nm_outlet" value="{{ $outlet->nm_outlet }}" required autocomplete="nm_outlet" autofocus>
                    </div>
                </div>
